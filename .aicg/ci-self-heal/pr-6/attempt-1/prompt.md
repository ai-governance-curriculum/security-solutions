...
- Annotations:
  ...
  - `modules/mod-003-cryptography-for-ml/exercise-05-encryption-in-use-decision/SOLUTION.md:213` (failure): modules/mod-003-cryptography-for-ml/exercise-05-encryption-in-use-decision/SOLUTION.md:213:1 MD004/ul-style Unordered list style [Expected: dash; Actual: plus] https://github.com/DavidAnson/markdownlint/blob/v0.34.0/doc/md004.md
  - `modules/mod-003-cryptography-for-ml/exercise-05-encryption-in-use-decision/SOLUTION.md:144` (failure): modules/mod-003-cryptography-for-ml/exercise-05-encryption-in-use-decision/SOLUTION.md:144:1 MD004/ul-style Unordered list style [Expected: dash; Actual: plus] https://github.com/DavidAnson/markdownlint/blob/v0.34.0/doc/md004.md
