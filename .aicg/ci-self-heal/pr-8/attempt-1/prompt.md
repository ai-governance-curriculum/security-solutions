...
- Details: <https://github.com/ai-infra-curriculum/ai-infra-security-solutions/actions/runs/26631501629/job/78481231042>
- Annotations:
  ...
  - `modules/mod-005-secrets-management/exercise-04-keyless-ci-design/SOLUTION.md:270` (failure): modules/mod-005-secrets-management/exercise-04-keyless-ci-design/SOLUTION.md:270:1 MD004/ul-style Unordered list style [Expected: dash; Actual: plus] https://github.com/DavidAnson/markdownlint/blob/v0.34.0/doc/md004.md
