...
### 1. Unresolved review thread (bot: @chatgpt-codex-connector) in `modules/mod-004-network-security/exercise-03-edge-gateway-hardening/SOLUTION.md:168`
...
### 2. Unresolved review thread (bot: @chatgpt-codex-connector) in `modules/mod-004-network-security/exercise-02-complete-networkpolicy-set/SOLUTION.md:331`
